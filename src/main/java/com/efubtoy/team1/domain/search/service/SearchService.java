...
public class SearchService {
    ...
    public SearchResponseDto Search(String searchWord){
        //Book
        List<Book> bookList = bookRepository.findByTitle(searchWord).orElseGet(Collections::emptyList);
        List<BookResponseDto> bookList1 = bookService.findBookWithLowestAndStock(bookList);
        ...
        return new SearchResponseDto(searchWord , bookList1 , recordList1  , goodsList);
    }
}
